...
<section class="bg-[url('https://www.idell.se/wp-content/uploads/2022/12/hangaren.jpeg')] bg-no-repeat bg-cover bg-center bg-gray-700 bg-blend-multiply bg-opacity-60">
          ...
          <div class="p-6 space-y-4 md:space-y-6 lg:space-y-8 sm:p-8">
              ...
              <form class="space-y-4 md:space-y-6" action="#">
                  ...
                  <div>
                      ...
                      <input bind:value={password} type="password" name="password" id="confirm-password" placeholder="••••••••" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" required={true}>
                  </div>
                  ...
                  <button on:click={signIn} type="submit" class="w-full text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Log in to your account</button>
